<template>
  <footer class="py-1 bg-slate-800 text-center text-gray-300 rounded-t-lg">
    <div class="flex wrap gap-10 md:gap-10 p-3 flex-row items-center justify-center">
    ...
    <p className='text-xs mt-2 text-gray-300'>
        © AfnanSiregar 2022. All rights reserved
    </p>
  </footer>
</template>
